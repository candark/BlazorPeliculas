           ...
           return new List<Pelicula>()
            {
                new Pelicula { Titulo = "Wakanda Forever", 
                                ...
                                Poster ="https://musicart.xboxlive.com/7/687d6400-0000-0000-0000-000000000002/504/image.jpg?w=1920&h=1080"},
                new Pelicula { Titulo = "Moana", 
                                Lanzamiento = new DateTime(2016, 11, 23),
                                Poster = "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRtxcWhkOciJi2B4JILXT1BK8GfXLPiKPmAQrYct3J6GzZfQbkT"},
                new Pelicula { Titulo = "Inception", 
                                Lanzamiento = new DateTime(2023,8, 1),
